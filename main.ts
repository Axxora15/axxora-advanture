...
scene.onOverlapTile(SpriteKind.Player, assets.tile`myTile1`, function (sprite, location) {
    level += 1
    startovaer()
    game.showLongText("itls me your princess is in another level", DialogLayout.Top)
})
...
let level = 0
game.showLongText("once upon a time there is an kid ,his name is axxora ,axxora is a friend of princess , one day there come some kidnapper from another kingdom and you know what they do", DialogLayout.Full)
